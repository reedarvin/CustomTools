...
Begin VB.Form AuditorToolkit 
   ...
   Caption         =   "Auditor Toolkit Professional Edition"
   ClientHeight    =   8910
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8985
   ...
   Begin VB.CheckBox chkUserRightsInfo 
      BackColor       =   &H80000005&
      Caption         =   "Get User Rights Info"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
      ...
      Width           =   2415
   End
   Begin VB.CheckBox chkServiceInfo 
      BackColor       =   &H80000005&
      Caption         =   "Get Service Info"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.CheckBox chkServerInfo 
      ...
      Width           =   2415
   End
   Begin VB.CheckBox chkAuditPolicyInfo 
      BackColor       =   &H80000005&
      Caption         =   "Get Audit Policy Info"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
      ...
      Width           =   2415
   End
   Begin VB.CheckBox chkInstalledPrograms 
      BackColor       =   &H80000005&
      Caption         =   "Get Installed Programs"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
...
Private Sub cmdStartScan_Click()
    ...
    If chkInstalledPrograms.Value = 1 Then
        strArgs = strArgs & "-p "

        bContinue = True
    End If

    If chkAuditPolicyInfo.Value = 1 Then
        strArgs = strArgs & "-c "
    ...
    If chkServiceInfo.Value = 1 Then
        strArgs = strArgs & "-j "

        bContinue = True
    End If

    If chkUserRightsInfo.Value = 1 Then
        strArgs = strArgs & "-k "
    ...
    If objFSO.FileExists(App.Path & "\AuditorToolkitPE.exe") Then
        sa.nLength = Len(sa)
        sa.bInheritHandle = 1

        If CreatePipe(hPipeRead, hPipeWrite, sa, 0) Then
            strCommand = """" & App.Path & "\AuditorToolkitPE.exe"" " & strArgs & " """ & txtInput.Text & """"
        ...
        End If
    Else
        MsgBox "Cannot find file """ & App.Path & "\AuditorToolkitPE.exe"".", vbCritical + vbOKOnly, "Error!"
    End If
